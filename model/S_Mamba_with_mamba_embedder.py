...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        # Embedding
        self.enc_embedding = Mamba(
                            d_model=configs.enc_in,  # Model dimension d_model
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        enc_out = self.enc_embedding2(enc_out, x_mark_enc) # covariates (e.g timestamp) can be also embedded as tokens
