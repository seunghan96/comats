...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.linear_pred = nn.Linear(configs.d_model,self.pred_len)
    ...
    def forecast(self, x_enc_local, x_enc_global, x_mark_enc):
        ...
        enc_local_out = self.enc_embedding_local(x_enc_local, None) # covariates (e.g timestamp) can be also embedded as tokens
        ...
        dec_out2 = self.linear_pred(enc_local_out).permute(0,2,1)
