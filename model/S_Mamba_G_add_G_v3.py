...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.linear_pred = nn.Linear(self.seq_len,self.pred_len)
    ...
    def forecast(self, x_enc_local, x_enc_global, x_mark_enc):
        ...
        #print('x_enc_local.shape',x_enc_local.shape)
        dec_out2 = self.linear_pred(x_enc_local.permute(0,2,1)).permute(0,2,1)
        #print('dec_out2.shape',dec_out2.shape)
